...
require("lazy").setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        callback = function(ev)
          ...
          vim.keymap.set('n', '<leader>FL', vim.lsp.buf.format, { noremap = true, silent = true, desc = 'Format buffer with LSP' })
          ...
          vim.keymap.set("n", "gr", require("telescope.builtin").lsp_references, { buffer = bufnr, desc = "[G]oto [R]eferences", nowait = true})
          ...
          vim.keymap.set("i", "<A-s>", "<cmd>LspOverloadsSignature<CR>", { desc = "Lsp Overloads Signature", noremap = true, silent = true, buffer = bufnr })
          vim.keymap.set("n", "<A-s>", "<cmd>LspOverloadsSignature<CR>", { desc = "Lsp Overloads Signature", noremap = true, silent = true, buffer = bufnr })
        end,
      })
    end,
  },
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>BQ", function() require("dap").terminate(); require("dap").clear_breakpoints() end, desc = "Debug: Terminate and Clear Breakpoints" },
    },
    config = function()
